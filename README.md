...
1. Explain what a token is used for.
   a token is used for storing sensitive information to our local storange to aunthenticate a user.

2. What steps can you take in your web apps to keep your data secure?
   set up an aunthentication like a jwt and make private routes

3. Describe how web servers work.
   data is stored in a server around the world. an api call asks for permission to access that data. if allowed, the server send that data back to our local server which we can then use.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
   C = create, like post R = Read, like getting data, U = Update, like put we can edit data and D = delete, like remove.
